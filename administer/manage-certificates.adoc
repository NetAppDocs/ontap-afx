...
* https://docs.netapp.com/us-en/ontap/authentication/install-server-certificate-cluster-svm-ssl-server-task.html[Generate and install a CA-signed server certificate in ONTAP^]
