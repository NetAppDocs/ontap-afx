...
Refer to link:https://docs.netapp.com/us-en/ontap/performance-admin/guarantee-throughput-qos-task.html[QoS throughput ceilings^].
...
Refer to link:https://docs.netapp.com/us-en/ontap/networking/improve-tcp-wan-performance.html[Improve TCP WAN performance with PRR and RACK] for more information.
...
You can offload Transport Layer Security (TLS) encryption and decryption for your entire cluster to supported Ethernet cards.  This reduces CPU overhead and improves performance for systems using TLS. Refer to https://docs.netapp.com/us-en/ontap/networking/configure-tls-offload.html[Configure ONTAP TLS hardware offload^] for more information.
...
* https://docs.netapp.com/us-en/ontap/data-protection/manage-snapmirror-root-volume-replication-concept.html[Learn about ONTAP SnapMirror root volume replication^]

// 2026 May 07, ONTAPDOC-3500, ONTAPDOC-3679