...
[big red]*DP: Please review the troubleshooting section. Not sure everything is possible, including the commands, when operating in either `admin` or 'advanced' privilege level.*
