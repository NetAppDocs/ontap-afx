---
sidebar: sidebar
permalink: administer/cluster-networking.html
keywords: 
summary: 
---
...
[.lead]
You can use ONTAP System Manager to perform basic storage network administration on your ONTAP AFX storage system. For example, you can add a broadcast domain or reassign ports to a different broadcast domain.

*=> DP: Add content or section about downloading cluster networking data. See link below.*
