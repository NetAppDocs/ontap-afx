...
[.lead]
You need to configure the network of your ONTAP AFX storage system. The networking environment supports several connection scenarios including clients accessing data at SVMs as well as intercluster communication.
