...
An AFX 1K storage controller can weigh up to 62.83 lb (28.5 kg). To lift the storage controller, use two people or a hydraulic lift.

.AFX 1K controller lifting precaution.
image::../media/drw_a1k_weight_caution_ieops-1698.svg[AFX 1K lifting caution icon]
