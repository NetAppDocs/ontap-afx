...
.What's next?
After you've installed the hardware for your AFX system, review the link:afx-cable-overview.html[supported cabling configurations for your AFX 1K storage system].
