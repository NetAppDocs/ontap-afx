...
After the initial configuration, complete the cluster setup using System Manager.

.About this task

Three areas of the AFX cluster are configured for setup. Complete all three if possible; only the first is required, and the last two are optional.
