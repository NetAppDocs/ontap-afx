...
summary: "After your AFX hardware has been installed, you can complete the cluster setup. This process involves related configuration phases that you need to perform sequentially."
---
...
[.lead]
After your AFX hardware has been installed, you can complete the ONTAP cluster setup. This process involves related configuration phases that you should perform sequentially.
...
There are several core requirements when setting up your AFX cluster.

.Hardware installation

Make sure you've completed the hardware installation of your AFX system. For more information, see link:../install-setup/install-setup-hardware.html[Install your AFX hardware].
