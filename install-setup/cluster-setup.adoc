...
[big red]*DP: This page needs to be thoroughly reviewed. I did not have access to an actual AFX cluster to test. Also, is there anything we should include from the cluster setup for Unified ONTAP? See:*
