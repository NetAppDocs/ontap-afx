...
[.lead]
After your AFX hardware has been installed, you can complete the AFX cluster setup. This process involves related configuration phases that you should perform sequentially. As part of this, you can optionally set up an AIDE cluster.

// https://docs.netapp.com/us-en/ontap/software_setup/workflow-summary.html

== Prepare to set up an AFX storage system

Before setting up your AFX cluster, you should review the core AFX requirements and additional AIDE considerations to ensure you have all the necessary information and resources to complete the setup process successfully.

[.big .red]*During the AIDE review, this section should carefully examined for errors.*
...
* Ensure the AIDE hardware has been properly installed and attached to the AFX storage network.
