...
summary: "After your AFX hardware has been installed, you can complete the ONTAP cluster setup. This process involves related configuration phases that you should perform sequentially."
---
...
Before setting up your ONTAP cluster, you should review the core AFX requirements to ensure you have all the necessary information and resources to complete the setup process successfully.
