...
Use the 4x100GbE breakout cable to connect the cluster, HA, and storage ports on the controllers to the cluster network switch B. Cluster and HA interconnect cable to connect ports e1b and e7b to switch B. The e1b ports are used for the HA connections, and the e7b ports are used for the cluster connections. For the storage connections, connect ports e10b and e11b to switch B.

Ensure you have the correct cables and connectors for your switches. See https://hwu.netapp.com[Hardware Universe^] for more information.

. Connect the following controller ports to any non-ISL port on switch B.
* Controller A
** e10b
** e11b
* Controller B
