...
+
image::../media/drw_a1K_back_slots_labeled_ieops-2162.svg[Slot numbering on an AFX controller, width=800px]
...
image::../media/drw_afx_management_connection_ieops-2815.svg[Connect to your management network, width=800px]
...
+
image::../media/drw_afx_network_cabling_a_ieops-2813.svg[Cable to Ethernet network, width=800px]
...
image::../media/oie_cable100_gbe_qsfp28.png[100 Gb Ethernet cable]
+
image::../media/drw_afx_network_cabling_b_ieops-2814.svg[Cable to Ethernet network, width=800px]
...
+
image::../media/drw_afx_ha_cluster_storage_a_ieops-2779.svg[Cable controller cluster, HA, and storage to switch A, width=800px]
...
image::../media/oie_cable100_gbe_qsfp28.png[100 Gb cable]
+
image::../media/drw_afx_ha_cluster_storage_b_ieops-2780.svg[Cable controller cluster, HA, and storage to switch B, width=800px]
