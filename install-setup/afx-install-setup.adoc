---
permalink: install-setup/afx-install-setup.html
sidebar: sidebar
...
* Administration instructions for configuring your system, including provisioning storage, cloning data, and resizing local storage.
