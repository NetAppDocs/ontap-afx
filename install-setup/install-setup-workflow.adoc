...
NOTE: If you are deploying AFX 1K with the AI Data Engine (AIDE), install the AIDE data compute nodes after powering on the AFX system. Refer to link:https://docs.netapp.com/us-en/ai-data-engine/install-setup/aide-hardware-requirements.html[Install AIDE data compute nodes] for more information.
