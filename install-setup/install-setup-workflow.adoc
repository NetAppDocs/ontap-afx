...
[NOTE]
====
If you are deploying AFX 1K with AI Data Engine (AIDE), you can install AIDE data compute nodes after you have finished installing the AFX system.

* For NetApp DCN deployments, see https://docs.netapp.com/us-en/ai-data-engine/install-setup/aide-dcn-hardware-requirements.html[requirements for AI Data Engine on NetApp-provided data compute nodes^].
* For third-party server deployments, see https://docs.netapp.com/us-en/ai-data-engine/install-setup/aide-mde-server-hardware-requirements.html[requirements for AI Data Engine with AIDE software on third-party servers^] and https://docs.netapp.com/us-en/ai-data-engine/install-setup/install-aide-as-software.html[install AIDE software on third-party servers^].
====
