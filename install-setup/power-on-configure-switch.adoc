...
* For Cisco Nexus 9364D-GX2A switches, see the cluster and storage switches documentation link:https://docs.netapp.com/us-en/ontap-systems-switches/switch-cisco-9364d-gx2a/configure-switch-workflow-93264d.html[Configure Cisco Nexus 9364D-GX2A switch^].
