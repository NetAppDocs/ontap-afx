...
* For AFX 1K with AI Data Engine (AIDE) deployments, go to the link:https://docs.netapp.com/us-en/ai-data-engine/install-setup/aide-hardware-requirements.html[Install AIDE data compute nodes].
