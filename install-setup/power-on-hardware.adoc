...
.What's next?
After powering on your AFX 1K storage system, complete the setup based on your deployment option:

* For dedicated AFX 1K storage system deployments, go to link:../install-setup/cluster-setup.html[Set up an AFX cluster].
* For AFX 1K with AI Data Engine (AIDE) deployments, install AIDE third-party servers or NetApp-provided data compute nodes:
