...
[TIP]
Most of the concepts and procedures used with ONTAP AFX data management are the same as Unified ONTAP. Review the resources available in <<Related information>> for more information including applicable Unified ONTAP documentation.
