...
[NOTE]
Most of the concepts and administrative procedures used with ONTAP AFX are the same with Unified ONTAP. Refer to <<Related information>> for more information.
