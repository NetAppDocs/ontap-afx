...
There are several limits, including minimums and maximums, enforced by ONTAP AFX. These limits fall into several different categories, including:

* Nodes per cluster
* Storage capacity

NetApp expects to rapidly expand the AFX capabilities and so these values will change, including within a single ONTAP release. You should review the information at the Interoperability Matrix Tool (IMT) to determine the capabilities of your cluster.
