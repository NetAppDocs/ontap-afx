...
On September 2, I reecived a master FAQ document from TME (Justin) that I'll draw from for more entries. Will also consider the following topics which may overlap:
