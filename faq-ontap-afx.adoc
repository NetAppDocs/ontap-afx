---
sidebar: sidebar
permalink: faq/faq-ontap-afx.html
keywords: 
summary: 
---
...
[big red]*DP: Justin provided a very large FAQ document (Sept 2). I haven't added all the entries yet and so this list will grow before product launch.*

// Comments for reviewers:
[big red]*DP: Are the following entries acceptable to include in the advanced technical section of this FAQ page?*
