...
The AFX storage system was announced at the NetApp Insight conference in October, 2025. The AFX systems support ONTAP 9.17.1 and later releases. You should contact your NetApp sales representative for more specific details.
...
.Can I use FlexCache to or from an AFX system cluster?

Yes. AFX storage systems support FlexCache both to and from an AFF or FAS system running the Unified ONTAP personality. The only restriction is FlexCache with write-back mode is not supported.
