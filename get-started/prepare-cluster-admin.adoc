...
Each AFX cluster must have at least four nodes. The maximum number of nodes varies based on the ONTAP release; for example the 9.19.1 release allows up to 64 nodes per AFX cluster.
