...
[NOTE]
One data SVM is created when you set up and initially deploy an ONTAP AFX cluster. You can create additional data SVMs if needed.
...
While you can use System Manager for most ONTAP AFX administration, there are some tasks you can only perform using the ONTAP command line interface.
