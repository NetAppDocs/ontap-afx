...
Each AFX cluster must have at least four nodes. The maximum number of nodes varies based on the ONTAP release; for example the 9.19.1 RC release allows up to 32 nodes in an AFX cluster.
