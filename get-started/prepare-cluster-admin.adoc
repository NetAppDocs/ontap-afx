...
To a large extent, all three share a common set of features and configuration options. To leverage this appropriately, this AFX documentation includes links to topics at the Unified ONTAP doc site. This additional content provides more depth and a different perspective that can be helpful as you administer your AFX storage system.
