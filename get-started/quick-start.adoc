...
= Quick start for setting up an ONTAP AFX system
:icons: font
:imagesdir: ../media/
...
[role="quick-margin-para"]
Follow the quick and easy process to link:../install-setup/workflow-setup.html[Set up] your ONTAP cluster using System Manager.
