...
summary: "NetApp AI Data Engine (AIDE) is a storage‑integrated AI data service that runs on NetApp data compute nodes (DX50) attached to an AFX cluster. You can optionally install and integrate AIDE with your AFX cluster, extending AFX by providing dedicated, GPU‑accelerated data processing for AI and ML workloads, while retaining all the benefits of ONTAP."
---
...
[.lead]
NetApp AI Data Engine (AIDE) is a storage‑integrated AI data service that runs on NetApp data compute nodes (DX50) attached to an AFX cluster. You can optionally install and integrate AIDE with your AFX cluster, extending AFX by providing dedicated, GPU‑accelerated data processing for AI and ML workloads, while retaining all the benefits of ONTAP.
