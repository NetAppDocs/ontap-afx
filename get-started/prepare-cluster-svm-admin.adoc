...
[NOTE]
The System Manager user interface is preferred in most cases and will be used to describe the administrative tasks. Exceptions will be noted where appropriate.
