...
[NOTE]
The System Manager user interface is preferred in most cases and is used to describe the administrative tasks. Exceptions are noted where appropriate. For most tasks you need to be using an administrator account.
