...
[NOTE]
The System Manager user interface is preferred in most cases and is used to describe the administrative tasks. Exceptions are noted where appropriate.
...
NetApp offers ONTAP in three distinct personalities. Where appropriate, the ONTAP AFX documentation includes links to the unified ONTAP doc site. In many cases, this provides more depth and a different perspective which can be helpful as you administer ONTAP AFX.
