...
[.lead]
The ONTAP AFX architecture is composed of several hardware and software components. These system components are organized in two different categories.
...
The following figure illustrates a typical deployment of an ONTAP AFX cluster. Notice the controller nodes are decoupled from the storage shelves and connected through a shared network.
