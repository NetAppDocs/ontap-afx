...
The following illustrates a typical deployment of an ONTAP AFX cluster. Notice the controller nodes are decoupled from the storage shelves and connected through a shared network.
