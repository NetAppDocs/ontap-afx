...
[big red]*DP: Justin provided a very large FAQ document (Sept 2) and so I've expanded the list to multiple pages. We may reorganize and move this content based on the IE standards. For example, maybe go back to one page with multiple sections with FAQ entries in collapsible blocks. Also, I haven't added all the entries yet.*
