...
[big red]*DP: I started this FAQ as a single page. Justin provided a much large FAQ document and so I've expanded to multiple pages. I have not yet completed adding all the entries. Maybe this content can be reviewed again after the initial IDR and before product launch.*
