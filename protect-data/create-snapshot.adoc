...
[.lead]
To back up data on your ONTAP AFX system, you need to create a snapshot. You can use ONTAP System Manager to create a manual snapshot of a volume or to create a consistency group and schedule automatic snapshots of multiple storage units at the same time. 
