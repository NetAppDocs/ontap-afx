...
[TIP]
Most of the concepts and procedures used for ONTAP AFX data protection are the same as Unified ONTAP. Review the resources available in <<Related information>> for more information including applicable Unified ONTAP documentation.
