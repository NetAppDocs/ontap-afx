...
summary: Learn how to install the switches for the AFX 2K storage system and storage shelves. 
---
= Install the switches for your AFX 2K storage system
:icons: font
:imagesdir: ../media/

[.lead]
After you complete your preparation for the AFX 2K storage system installation, you should install the switches in the cabinet or telco rack.
...
NOTE: If the airflow for your switches is configured for port-side intake (burgundy colored fans and PSUs), the network ports for the switches must be installed facing the front of the cabinet, and the exhaust fans must face the rear of the cabinet. With this configuration, you must ensure that you use cables long enough to run from the network ports in the front of the cabinet to the storage ports in the rear of the cabinet. + 
For more detailed information about these switches, please visit the Cisco website: link:https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/hw/9800/9808/nx-os/cisco-nexus-9808-nx-os-mode-switch-hardware-installation-guide/m-8000-modular-overview-ph2.html[Cisco Nexus 9808 Mode Switch Hardware Installation Guide^], link:https://www.cisco.com/c/en/us/td/docs/dcn/hw/nx-os/nexus9000/9332d-gx2b/cisco-nexus-9332d-gx2b-nx-os-mode-switch-hardware-installation-guide.html[Cisco Nexus 9332D-GX2B Mode Switch Hardware Installation Guide^],  and link:https://www.cisco.com/c/en/us/td/docs/dcn/hw/nx-os/nexus9000/9364d-gx2a/cisco-nexus-9364d-gx2a-nx-os-mode-switch-hardware-installation-guide.html[Cisco Nexus 9364D-GX2A Mode Switch Hardware Installation Guide^].
...
If you are installing the Cisco Nexus 9808 switch, refer to the link:https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/hw/9800/9808/nx-os/cisco-nexus-9808-nx-os-mode-switch-hardware-installation-guide/m-8000-install-chassis.html[Cisco Nexus 9808 Mode Switch Hardware Installation Guide^] for detailed instructions on how to install the switches in the cabinet or rack.

== Cisco Nexus 9332D-GX2B and 9364D-GX2A switch installation
If you are installing Cisco Nexus 9332D-GX2B or 9364D, perform the following the steps to install the switches in the cabinet or rack. 
...
+
 ...
 .. Thread the female connectors of both jumper cords from the rear of the panel through the brush assembly.
+
...
+
Mount the two switches in cabinet locations that provide efficient access to controllers and shelves, such as the middle rows.
...
.What's next?
After you install the switches in the cabinet or rack, you link:deploy-hardware.html[install the AFX 2K storage system and shelves in the cabinet or rack].
