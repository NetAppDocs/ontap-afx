...
+
image::../media/drw_afx_2k_storage_connection_a_ieops-temp.png[Cable controller storage to switch A]
...
image::../media/oie_cable100_gbe_qsfp28.png[100 Gb cable]
+
image::../media/drw_afx_2k_storage_connection_b_ieops-temp.png[Cable controller storage to switch B]
