...
+
image::../media/drw_afx_2k_rear_slots_ieops-2862.svg[Slot numbering on an AFX controller,width=800px]
+
...
image::../media/drw_afx_2k_management_connection_ieops-2863.svg[Connect to your management network,width=800px]
...
*400GbE cables*
+
image::../media/oie_cable100_gbe_qsfp28.png[400 Gb Ethernet cable]
+
image::../media/drw_afx_2k_host_switch_a_ieops-2864.svg[Cable to Ethernet network, width=800px]
...
image::../media/oie_cable100_gbe_qsfp28.png[400 Gb Ethernet cable]
+
image::../media/drw_afx_2k_host_switch_b_ieops-2865.svg[Cable to Ethernet network, width=800px]
...
+
image::../media/drw_afx_2k_cluster_switch_a_ieops-2866.svg[Cable cluster connections to cluster network, width=800px]
...
image::../media/oie_cable_25Gb_Ethernet_SFP28_ieops-1069.png[Cluster HA cable]
+
image::../media/drw_afx_2k_cluster_switch_b_ieops-2867.svg[Cable cluster connections to cluster network, width=800px]
...
+
image::../media/drw_afx_2k_storage_connection_a_ieops-2868.svg[Cable controller storage to switch A, width=800px]
...
image::../media/oie_cable100_gbe_qsfp28.png[100 Gb cable]
+
image::../media/drw_afx_2k_storage_connection_b_ieops-2870.svg[Cable controller storage to switch B, width=800px]
...
image::../media/oie_cable100_gbe_qsfp28.png[100 Gb cable]
+
image::../media/drw_afx_shelf_cabling_a_ieops-2356.svg[Cable shelf to switch A and switch B, width=800px]
...
image::../media/oie_cable100_gbe_qsfp28.png[100 Gb cable]
+
image::../media/drw_afx_shelf_cabling_b_ieops-2357.svg[Cable shelf to switch A and switch B, width=800px]
