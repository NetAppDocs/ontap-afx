...
---
= Network requirements for your AFX 2K storage system
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
Record the required information for each network you connect to your AFX 2K storage system. 

== Gather network information
Before you begin the installation of your AFX 2K storage system, gather the required network information
...
For Cisco Nexus 9808 NX-OS, Cisco Nexus 9332D-GX2, and 9364D-GX2A switch installation and maintenance, be sure to review cabling and network requirements.
...
.What's next?
After reviewing the network requirements, you link:cable-hardware.html[cable the controllers and storage shelves for your AFX 2K storage system].