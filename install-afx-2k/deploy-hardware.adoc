...
summary: Learn how to install the rail kits for the AFX 2K storage system and storage shelves, and secure the AFX hardware in the cabinet or telco rack. 
---
= Install your AFX 2K storage system
:icons: font
:imagesdir: ../media/

[.lead]
After you install the switches, you should install the hardware for your AFX 2K storage system. First, install the rail kits. Then install and secure your storage system in a cabinet or telco rack.
...
+
. If your AFX 2K storage system came with a cable management device, attach it to the rear of the storage system.
+
...
.What's next?
After you've installed the hardware for your AFX system, review the link:afx-cable-overview.html[supported cabling configurations for your AFX 2K storage system].
