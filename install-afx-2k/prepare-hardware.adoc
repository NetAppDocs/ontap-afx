...
summary: Prepare to install the AFX 2K storage system in your ONTAP environment and register the hardware to access support benefits. 
---
= Prepare to install your AFX 2K storage system
:icons: font
:imagesdir: ../media/

[.lead]
Prepare to install your AFX 2K storage system by getting the site ready, unpacking the boxes and comparing the contents of the boxes to the packing slip, and registering the system to access support benefits.

== Step 1: Prepare the site
To install your AFX 2K storage system, ensure that the site and the cabinet or rack that you plan to use meet specifications for your configuration.
...
** 1U for the Cisco Nexus 9332D-GX2B switch.
** 2U for the Cisco Nexus 9364D-GX2A switch.
** 16U for the Cisco Nexus 9808 switch. 
...
* Storage shelf
* Cisco Nexus 9808, 9332D-GX2B, or 9364D-GX2A switch
...
After you ensure that your site meets the requirements for your AFX 2K storage system specifications, and you verify that you have all the parts you ordered, register your storage system.
...
a|
 ...
 .. Select *Register Now*, and create an account.
...
.What's next?
After you've prepared to install your AFX 2K hardware, you link:install-switches.html[install the switches for your AFX 2K storage system].
